  ...
  init(t, e) {
    t.id && (this.userId = t.id),
      ...
      this.layout &&
        t.pic &&
        (this.pic =
          `<img alt="${t.imageAlt ? t.imageAlt : "Black Lives Matter Badge"}" width="30" style="border-radius:100%" src="${t.pic}"/>&nbsp;&nbsp;`),
      (this.mounted = !0),
      this.run(e);
  },
  run(t) {
    ...
    const h = b.pic ? b.pic : g,
      u =
        `<img alt="${b.imageAlt ? b.imageAlt : "Black Lives Matter Badge"}" style="${c}" width="${2 === b.layout ? 50 : 30}" class="maker-badge__btn-img" src="${h}"/>&nbsp;&nbsp;`,
    ...
    1 === b.layout
      ...
      (a.innerHTML +=
        `<div style="color:#4a5568;max-width:200px;padding:0.5rem 0px 0;line-height:1.2rem">${b.message}</div>`),
      (n.innerHTML +=
        `<div style="margin-top:0.5rem;"><a style="color:#2B6CB0;text-decoration:underline;font-weight: 600;" target="_blank" href="${b.promoLink}">${b.promoText}</a></div>`),
      a.appendChild(n),
  ...
  setStyle() {
    ...
    if (
      ...
      const i =
        ...
        a =
          `.maker-badge{z-index:99;max-width:200px;color:#2b2b2b;font-size:16px;font-family:helvetica;text-align:right;height:auto;min-width:160px;position:fixed;bottom:-100%;${this.position}:0;border-top-left-radius:6px;}`,
        o =
      ...
      this.style.innerHTML =
        `.transition {transition: all .3s ease}${r}${s}${i}${a}${o}${n}${e}${t}`;
    }
    if (2 === this.layout) {
      t =
      ...
      const i =
          ".maker-badge, .maker-badge *,.maker-badge *:before,.maker-badge *:after{box-sizing: border-box;}",
        a =
          `.maker-badge{z-index:99;visibility:hidden;color:#2b2b2b;font-size:16px;font-family:helvetica;text-align:${this.position};height:auto;min-width:160px;position:fixed;bottom:-100%;${this.position}:0;border-top-left-radius:6px;}`,
        o =
      ...
      this.style.innerHTML =
        `.transition {transition: all .3s ease}${r}${s}${i}${a}${n}${e}${t}${o}`;
    }
  },
};
